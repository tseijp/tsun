...
import { Canvas, useResourc, useThree } from 'react-three-fiber/css3d'
const Controller = forwardRef(
    ({
        size=100, limit=100, portal=null, onDrag=null,
        ...props
    }, ref) => {
    ...
    const child = useMemo(() => {
        const style = {position:"fixed", zIndex:1, width:"100%", height:"100%",top:0,left:0}
